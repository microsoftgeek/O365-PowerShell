...
$msolUsers = Get-MsolUser -EnabledFilter EnabledOnly -MaxResults 20000 | Where-Object {($_.licenses).AccountSkuId -eq 'ACProducts:ENTERPRISEPACK'} | Select DisplayName,UserPrincipalName,ObjectId
